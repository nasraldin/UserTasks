...
namespace UserTasks.Migrations
{
    ...
    [Migration("20180929004014_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserTasks.Core.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("UserTasks.Core.Entities.TaskItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("UserTasks.Core.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("UserTasks.Core.Entities.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("UserTasks.Core.Entities.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("UserTasks.Core.Entities.TaskItem", b =>
                {
                    b.HasOne("UserTasks.Core.Entities.User", "UserOwner")
                        .WithMany("Tasks")
