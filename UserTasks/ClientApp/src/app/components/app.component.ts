...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  get canManageTasks() {
    return this.accountService.userHasPermission(Permission.manageTasksPermission);
  }

  get canAssignTasks() {
    return this.accountService.userHasPermission(Permission.assignTasksPermission);
  }
}
